...
Все внешние запросы (LLM, OCR, Langfuse) должны идти через HTTP-прокси,
кроме хостов из bypass-списка (по умолчанию tenderplan.ru).

URL прокси задаёт backend-разработчик через переменную окружения, до этого
...
Использование в коде:
    ...
    from app.clients.http_proxy import build_httpx_client
